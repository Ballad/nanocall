#ifndef __FORWARD_BACKWARD_CUSTOM_HPP
#define __FORWARD_BACKWARD_CUSTOM_HPP
...
public:
    ...
    Float_Type log_posterior(unsigned i, unsigned j) const { return cell(i, j).gamma; }
    ...
    friend std::ostream& operator << (std::ostream& os, const Forward_Backward_Custom& fwbw)
    {
